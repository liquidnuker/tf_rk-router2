...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matchPath__ = __webpack_require__(38);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _ParamTester = __webpack_require__(152);

var _ParamTester2 = _interopRequireDefault(_ParamTester);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          { to: "/projects/subroute1" },
          "SubRoute1"
        )
      )
    ),
    routes.map(function (route, i) {
      return React.createElement(RouteWithSubRoutes, (0, _extends3.default)({ key: i }, route));
    })
  );
}

function ProjectSub1(_ref3) {
...
// route config
// ======================================================/
var routes = [{ path: '/about',
  component: About
}, { path: '/pt/:item',
  component: _ParamTester2.default
}, { path: '/projects',
  component: Projects,
  routes: [{ path: '/projects/subroute1',
    component: ProjectSub1
  }]
}, { path: '/contact',
  component: Contact,
  routes: [{ path: '/contact/subroute1',
...
var RouteWithSubRoutes = function RouteWithSubRoutes(route) {
  return React.createElement(_reactRouterDom.Route, { path: route.path, render: function render(props) {
      return (
        // pass the sub-routes down to keep nesting
        React.createElement(route.component, (0, _extends3.default)({}, props, { routes: route.routes }))
      );
    } });
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(_reactRouterDom.Redirect, { from: "/1111", to: "/" }),
...
ReactDOM.render(React.createElement(RouteConfigExample, null), document.getElementById('root'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createBrowserHistory__ = __webpack_require__(91);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(52),p=__webpack_require__(53);__webpack_require__(31);var r=__webpack_require__(32);
...
var require$$0 = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createMemoryHistory__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(105);
...
var Home_Main = function (_React$Component) {
  (0, _inherits3.default)(Home_Main, _React$Component);

  function Home_Main(props) {
    (0, _classCallCheck3.default)(this, Home_Main);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Home_Main.__proto__ || (0, _getPrototypeOf2.default)(Home_Main)).call(this, props));
  ...
  (0, _createClass3.default)(Home_Main, [{
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(45)(Function.call, __webpack_require__(69).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
exports.default = ParamTester1;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var PT1 = function (_React$Component) {
  (0, _inherits3.default)(PT1, _React$Component);

  function PT1(props) {
    (0, _classCallCheck3.default)(this, PT1);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PT1.__proto__ || (0, _getPrototypeOf2.default)(PT1)).call(this, props));
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          null,
          "match.params.item: ",
          this.props.pr_match_params_item
        )
      );
    }
  }]);
...
function ParamTester1(_ref) {
  var match = _ref.match;

  return React.createElement(
    "div",
    null,
    React.createElement(PT1, {
      pr_match_url: match.url,
